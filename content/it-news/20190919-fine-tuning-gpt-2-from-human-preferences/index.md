...
description: We’ve fine-tuned the 774M parameter GPT-2 language model using human
  feedback for various tasks, successfully matching the preferences of the external
  human lab
draft: false
original_url: https://openai.com/index/fine-tuning-gpt-2
source: OpenAI Blog
tags:
- Safety & Alignment
...
---
*원문: [https://openai.com/index/fine-tuning-gpt-2](https://openai.com/index/fine-tuning-gpt-2)*
